    ...
    <div className="">
      <div className="relative w-full">
        <nav className="fixed z-10 w-full bg-white md:absolute md:bg-transparent">
          <div className="container m-auto px-2 md:px-12 lg:px-7 max-w-7xl mx-auto">
              ...
              <div className="w-full px-6 flex justify-between lg:w-max md:px-0">
                ...
                >
                  ...
                  <span className="text-2xl font-bold text-yellow-900">
                    Roni's <span className="text-yellow-700">Foodi</span>
                  </span>
                </a>
        ...
        <div className="relative bg-yellow-50 ">
          <div className="container m-auto px-6 pt-32 md:px-12 lg:pt-[4.8rem] lg:px-7 max-w-7xl mx-auto">
